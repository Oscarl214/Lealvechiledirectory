          ...
          <form className="max-w-md">
            ...
            <div className="relative">
              ...
              <input
                type="search"
                id="default-search"
                className="block w-full p-4 pl-[4rem] pr-[4rem] text-lg text-gray-900 border border-gray-300 rounded-sm bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Search Car Model"
                required
              />
              <button
                type="submit"
                className="text-white underline absolute end-2.5 bottom-2.5 bg-trasnparent focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-trasnparent dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              >
                Search
              </button>
            </div>
