...
function SignInPage() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          'linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.5)), url(https://firebasestorage.googleapis.com/v0/b/lealvehicledirectory.appspot.com/o/SignUpPageGTR.jpg?alt=media&token=0bd51fcd-b6ab-4018-85ca-ce1e660b6dc4)',
        backgroundSize: 'cover',
        backgroundPosition: 'center',
        backgroundRepeat: 'no-repeat',
      }}
    >
      <main className="flex wrap-reverse lg:flex-nowrap h-screen w-screen flex-col lg:flex-row items-center justify-around ">
        <section>
          <div className="flex flex-col items-center justify-center lg:py-0">
            ...
            >
              <h1 className="text-xl text-blue text-center  text-white bg-black m-2">
